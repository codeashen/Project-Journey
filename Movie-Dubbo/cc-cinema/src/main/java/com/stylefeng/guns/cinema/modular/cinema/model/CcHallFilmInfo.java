package com.stylefeng.guns.cinema.modular.cinema.model;
 ...
 * @since 2020-10-29
 */
@TableName("cc_hall_film_info")
public class CcHallFilmInfo extends Model<CcHallFilmInfo> {
