...
import com.stylefeng.guns.order.modular.order.dao.CcOrder2018Mapper;
...
@Slf4j
@DubboService(group = "old")
public class OrderService2018Impl implements OrderService {

    @Autowired
    private FTPUtil ftpUtil;
    @Autowired
    private CcOrder2018Mapper ccOrderMapper;

    @DubboReference(check = false, version = "1.0", group = "", merger = "true")
