...
import com.stylefeng.guns.order.modular.order.dao.CcOrder2017Mapper;
...
public class OrderService2017Impl implements OrderService {

    @Autowired
    private FTPUtil ftpUtil;
    @Autowired
    private CcOrder2017Mapper ccOrderMapper;
