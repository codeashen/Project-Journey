package com.stylefeng.guns.film.modular.film.model;
 ...
 */
@TableName("cc_film")
public class CcFilm extends Model<CcFilm> {
    ...
    public Date getFilmime() {
        return filmime;
    }

    public void setFilmime(Date filmime) {
        this.filmime = filmime;
    }
